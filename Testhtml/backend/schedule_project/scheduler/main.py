      ...
      def load_data():
          ...
          for ts in teacher_schedules:
              course_data.append({
                  ...
                  'curriculum_type': ts.curriculum_type_teacher,
                  'room_type': ts.room_type_teacher,
                  'section_count': ts.section_teacher,
          ...
          for ps in pre_schedules:
              ...
              locked_data.append({
                  ...
                  'curriculum_type': ps.curriculum_type_pre,
                  'room_type': ps.room_type_pre,
                  'section': ps.section_pre,
                  'theory_slot': ps.theory_slot_amount_pre,
                  'lab_slot': ps.lab_slot_amount_pre,
                  'day': ps.day_pre,
                  'start_time': start_hour,
                  'stop_time': stop_hour,
                  'room_name': ps.room_name_pre
              })
